...
var jsonCompositeTemplate = '<div id="json-composite"><div id="validator-placeholder1"></div><div id="validator-placeholder2"></div><div id="diff-placeholder"></div><a href="#" title="Tips and Tricks" id="help"><span class="icon">Tips and Tricks</span></a><div id="tips-and-tricks"><a id="close-tips" class="close-btn" href="#">X</a><h1>JSON Lint Pro for Desktop</h1><h2>The easiest way to validate and format JSON.</h2><ul><li>Type your JSON into the textarea, or enter a remote URL</li><li>Use the split mode to speed up your workflow, or to run a diff.</li><li>Use the delete button to quickly clear your input.</li></ul><p>Ported to node-webkit by <a class="js-external-link" href="https://daawesomep.github.io/">DaAwesomeP</a>. Originally a project from the <a class="js-external-link" href="http://lab.arc90.com">Arc90 Lab</a>. Check out the source on <a class="js-external-link" href="https://github.com/DaAwesomeP/jsonlintpro-desktop">GitHub</a>. Props to <a class="js-external-link" href="http://www.crockford.com/">Douglas Crockford</a> of <a class="js-external-link" href="http://www.json.org">JSON</a> and <a class="js-external-link" href="http://www.jslint.com">JS Lint</a>, and <a class="js-external-link" href="http://zaa.ch/">Zach Carter</a>, who provided the <a class="js-external-link" href="https://github.com/zaach/jsonlint"> JS implementation of JSONlint</a>.</p></div></div>',
